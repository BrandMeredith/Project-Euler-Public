...
public class PE11Procedural {

	public static void main(String[] args) {
		// TODO Auto-generated method stub
		int[][] myBox = new int[26][23];
		...
		Scanner s = new Scanner(longString);

		// put tokens into a box
		for (int i=0;i<rowDim+6;i++)
			for (int j=0;j<colDim+3;j++)
				myBox[i][j] = s.nextInt();
		...
		for (int i=3;i<rowDim+3;i++)
			for (int j=0;j<colDim;j++)
				for (int[] myDir:directions){
					int prod = 1; 
					for (int k=0;k<4;k++)
						prod = prod * myBox[i+k*myDir[0]][j+k*myDir[1]];
